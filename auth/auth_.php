...
class flexibleAccess{
   ...
   * var string
   */
  var $dbUser = 'nirgiservis';
  /**
   * The database password
   * var string
   */
  var $dbPass = 'Rjhjnf^NS2012';
  /**
   * The database table that holds all the information
   * var string
   */
  var $dbTable  = 'auth_members';
  /**
   ...
   * var int
   */
  var $remTime = 30;//2592000;One month
  /**
 ...
 //if(!mysql_select_db($this->dbName)){die( mysql_error());
