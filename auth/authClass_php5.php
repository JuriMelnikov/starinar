...
class flexibleAccess{
  ...
  */
  ...
  echo" проверяем логин ";
		...
		if ( $loadUser ) {echo " Определяем userID и сессию, прописываем куки ";
  ...
  */
  private function query($sql, $line = 'Uknown') {
    if ($DEVELOPMENT_MODE) echo '<b>Query to execute: </b>'.$sql.'<br /><b>Line: </b>'.$line.'<br />';
